...
function ProgramSelector({ value, onChange ,userId}) {
  ...
  const handleAddNewProgram = () => {
    ...
    if (trimmed !== "" && !programs.includes(trimmed)) {
      ...
      setNewProgramType("");
      onChange({ target: { name: "program", value: trimmed } });
    }
  };
    ...
    <div>
      ...
      {showNewProgramInput && (
        <div className="input-group mb-3">
          ...
          />
          <button className="btn btn-success" type="button" onClick={handleAddNewProgram}>
            ADD
          </button>
        </div>
      )}
